...
def scrape_techcrunch(output_file = "profil.json"):
...
# Écrire dans un fichier JSON
    with open(output_file, "w", encoding="utf-8") as fichier: # le fichier est ouvert en mode écriture ("w")
...
#permettre au script  d'être exécutés directement ou  importé
if __name__ == "__main__":
    articles = scrape_techcrunch() # Exécuter le scraping
